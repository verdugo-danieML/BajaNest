...
def train_val_test_split(json_file_path, output_dir, img_path):
    ...
    validation_size = int(0.1 * len(image_ids))
...
def find_min_max_dimensions(images_folder):
    ...
    # Inicializa los valores mínimos y máximos de ancho y alto
    min_width = float('inf')
    ...
    for image_file in image_files:
        ...
        # Actualiza los valores mínimos y máximos de ancho y alto
